namespace ExpCrab
{
	...
	{
		"weapons/paranoia/headcrab/hc_pain1.wav",
		"weapons/paranoia/headcrab/hc_pain2.wav",
		"weapons/paranoia/headcrab/hc_pain3.wav"
	};
	const array<string> pAttackSounds = 
	{
		"weapons/paranoia/headcrab/hc_attack1.wav",
		"weapons/paranoia/headcrab/hc_attack2.wav",
		"weapons/paranoia/headcrab/hc_attack3.wav"
	};

	const array<string> pDeathSounds = 
	{
		"weapons/paranoia/headcrab/hc_die1.wav",
		"weapons/paranoia/headcrab/hc_die2.wav"
	};

	const array<string> pBiteSounds = 
	{
		"weapons/paranoia/headcrab/hc_headbite.wav"
	};
	
	const int HC_AE_JUMPATTACK = 2;
    const int HC_AE_ROTATEYAW = 60;
	const string EXPLOSION_SPR = "sprites/spore_exp_01.spr";
	const string HEADCRAB_MODEL = "models/paranoia/headcrab.mdl";
	const string HEADCRAB_NAME = "Toxiclosive";
	...
	class CExpCrab : ScriptBaseMonsterEntity
	{
        ...
        void Detonate()
		{
			...
			m.End();
            g_WeaponFuncs.RadiusDamage( self.pev.origin, self.pev, self.pev, flExploDamage, flExploRange, CLASS_NONE, DMG_BLAST | DMG_TIMEBASED | DMG_POISON );
            NetworkMessage message( MSG_BROADCAST, NetworkMessages::ToxicCloud, null);
                message.WriteCoord(self.pev.origin.x);//x
                message.WriteCoord(self.pev.origin.y);//y
                message.WriteCoord(self.pev.origin.z);//z
            message.End();
		}
